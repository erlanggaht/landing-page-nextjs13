  ...
  return (
    <div id="main-content" className={style.mainContent}>
      <div id="content" className={style.content}>
        ...
        <p id="paragrafMainContent" style={{margin:"1rem 0",width:"60%",fontSize:".9rem",color:"#A0A3AC"}}>
      ...
      <span id="image-content">       <Image src={programmerUndraw} height="200" width='200' style={{width:'auto',height:"auto"}} alt={'image-undraw-programer'} className={style.imgcontent}/>
      </span>
